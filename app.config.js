module.exports = {
  expo: {
    ...
    icon: "./assets/images/endorsementicon.png",
    scheme: "myapp",
    ...
    splash: {
      image: "./assets/images/endorsementicon.png",
      resizeMode: "contain",
    ...
    android: {
      adaptiveIcon: {
        foregroundImage: "./assets/images/endorsementicon.png",
        backgroundColor: "#ffffff"
      },
    ...
    web: {
      bundler: "metro",
      output: "static",
      favicon: "./assets/images/endorsementicon.png",
      name: "Endorse",
      shortName: "Endorse",
