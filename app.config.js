module.exports = {
  expo: {
    ...
    icon: "./assets/images/uprightmoneysc.png",
    scheme: "myapp",
    ...
    splash: {
      image: "./assets/images/uprightmoneysc.png",
      resizeMode: "contain",
    ...
    android: {
      adaptiveIcon: {
        foregroundImage: "./assets/images/uprightmoneysc.png",
        backgroundColor: "#ffffff"
      },
    ...
    web: {
      bundler: "metro",
      output: "static",
      favicon: "./assets/images/uprightmoneysc.png",
      name: "Upright",
      shortName: "Upright",
