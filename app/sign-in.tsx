...
export default function SignInScreen() {
  ...
  // Mount guard to avoid differences between SSR/hydration and client render.
  // Only render OAuth buttons after we are mounted on the client.
      ...
      >
        ...
        <View style={{ flex: 1, alignItems: 'center' }}>
          <View style={{ width: '100%', maxWidth: isTabletOrLarger ? '50%' : 768 }}>
            ...
            {/* OAuth buttons: render only after mount to avoid hydration mismatch */}
            {mounted && (
...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 32, fontWeight: '700' as const, marginBottom: 8, textAlign: 'center' },
  subtitle: { fontSize: 16, textAlign: 'center', marginBottom: 32 },
  errorContainer: { flexDirection: 'row', alignItems: 'center', gap: 8, padding: 12, borderRadius: 8, borderWidth: 1, marginBottom: 24 },
  errorText: { fontSize: 14, flex: 1 },
  oauthContainer: { gap: 12, marginBottom: 24 },
  oauthButton: { paddingVertical: 14, paddingHorizontal: 20, borderRadius: 12, borderWidth: 1, alignItems: 'center' },
  oauthButtonText: { fontSize: 16, fontWeight: '600' as const },
  ...
  signInButton: { paddingVertical: 16, borderRadius: 12, alignItems: 'center', marginTop: 8 },
  signInButtonText: { fontSize: 17, fontWeight: '600' as const },
  footer: { flexDirection: 'row', justifyContent: 'center', alignItems: 'center' },
  footerText: { fontSize: 15 },
  footerLink: { fontSize: 15, fontWeight: '600' as const },
});
