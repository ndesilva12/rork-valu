        ...
        <View style={styles.subsectionRow}>
          <TouchableOpacity
            style={[
              ...
              forYouSubsection === 'aligned' && styles.subsectionButtonActive,
          ...
          <TouchableOpacity
            style={[
              styles.subsectionButton,
              forYouSubsection === 'unaligned' && styles.subsectionButtonActive,
              { borderBottomColor: colors.primary }
            ]}
          ...
          <TouchableOpacity
            style={[
              styles.subsectionButton,
              forYouSubsection === 'news' && styles.subsectionButtonActive,
              { borderBottomColor: colors.primary }
            ]}
